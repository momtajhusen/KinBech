...
export const APP_PERMISSIONS = [
  ...
  {
    id: 'video',
    name: 'Camera & microphone (listing video)',
    android: 'CAMERA, RECORD_AUDIO',
    ios: 'Camera and microphone access',
    required: false,
    when: 'When you record a short listing video (max 30 seconds)',
    why: 'Let sellers attach one in-app recorded product video to a listing.',
    data: 'Only the video you record in the app is compressed and uploaded. Gallery video pick is not used.',
    optional: true,
  },
  {
    id: 'notifications',
